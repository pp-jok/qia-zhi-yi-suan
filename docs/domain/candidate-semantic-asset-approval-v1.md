...
The reviewed candidate bundle is approved for isolated candidate Core Profile
execution and calibration. This approval changes no file under
`destiny-personality/configs/`, enables no default route, and does not certify
strict production calculation or reader-facing reporting.

## Review basis

- C1 primitive names remain system-neutral, include non-implications and do not
...
This approval does not supply the strict-production canonical vocabulary,
deterministic lookup rows, node policy, boundary margins, comparison
